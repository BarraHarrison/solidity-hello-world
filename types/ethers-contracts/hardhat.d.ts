...
getContractFactory(name: 'HelloBlockchain', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.HelloBlockchain__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'HelloBlockchain', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.HelloBlockchain>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'HelloBlockchain', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.HelloBlockchain>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'HelloBlockchain', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.HelloBlockchain>
